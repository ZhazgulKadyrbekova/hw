/* NxM массиви берилген. Элементтер кайталанбайт. Максималдуу элемент менен минималдуу элемент жайгашкан саптарды орундары менен алмаштыргыла.  Эгерде алар бир сапта жайгашса, ал жөнүндө билдирүү жасагыла.While циклды колдонгула.
*/
